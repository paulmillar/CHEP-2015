...
problems, with patches being sent @@[this is not clear.  Who is
  writing the patches, who is receiving them??]@@.  These patches have
been accepted in new releases of both dCache and ownCloud, in keeping
with the desired goal of running unpatched software.

This experience, both in running the software and with DESY's ability
to diagnose and fix problems as they are found, leave us confident as
we roll out the software to all members of DESY.

@@[Suggest rewriting this: The experience gained from running the
  software and the DESY team's alacrity in diagnosing and fixing
  problems as they are found, instill a high degree of confidence in
  the viability of this solution as we roll out the software to all
  members of DESY]@@
...
@@[why the new paragraph? join this with preceding]@@ Introducing a
notification scheme would allow clients to react quickly while not
placing too great a burden on the server.
...
be funded, we anticipate this policy will continue and the service
will be supported from indirect funding.
